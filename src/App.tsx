      ...
      <aside className="w-64 bg-[#0d121f] border-r border-slate-800/60 flex flex-col justify-between shrink-0">
        <div className="p-3 space-y-4 overflow-y-auto">
          ...
          <div className="space-y-1 pt-2">
            ...
            {['Company Brain', 'Documents', 'Meeting Notes'].map((kb) => (
              <div key={kb} className="flex items-center gap-2.5 px-2.5 py-1.5 text-xs text-slate-400 hover:bg-slate-800/40 rounded-md cursor-pointer">
